      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400">Real-time coordinates updates from vehicle telemetry</p>
          </div>
          <button 
            onClick={pollLocation}
            className="flex items-center gap-1.5 text-xs font-semibold text-slate-300 hover:text-white bg-slate-950/20 px-3.5 py-2.5 rounded-xl border border-slate-800 transition-colors"
          >
            <FaRedo size={12} />
            Refresh
          </button>
        ...
        {loading ? (
          <div className="h-96 bg-slate-950/20 border border-slate-800 animate-pulse rounded-3xl flex items-center justify-center text-slate-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Map Container */}
            <div className="md:col-span-2 bg-slate-950/40 p-3 rounded-3xl border border-slate-800/80 h-[420px] overflow-hidden relative">
              <div 
                ref={mapContainerRef} 
            ...
            {/* Live Metrics Column */}
            <div className="bg-slate-950/40 border border-slate-800/80 rounded-3xl p-6 flex flex-col justify-between gap-6">
              <div className="space-y-6">
                <h3 className="text-sm font-extrabold text-white uppercase tracking-wider">Bus Telemetry</h3>
                ...
                <div className="space-y-4">
                  ...
                  {/* ETA indicator */}
                  <div className="flex gap-4">
                    <div className="p-3 bg-emerald-500/10 rounded-xl text-emerald-400 h-fit">
                      <FaClock size={18} />
                    </div>
                    <div>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className={`
                    ...
                    ${sosTriggered 
                      ? 'bg-rose-700 text-rose-100 border border-rose-600 shadow-lg shadow-rose-900/35' 
                      : 'bg-gradient-to-r from-rose-600 to-red-700 hover:from-rose-500 hover:to-red-600 text-white shadow-lg shadow-rose-500/25 animate-pulse'
                    }
                  `}
                >
              ...
              {/* Status footer card */}
              <div className="p-4 bg-slate-900/60 rounded-2xl border border-slate-800/60 text-xs text-slate-400 leading-normal space-y-1.5">
                <span className="font-bold text-slate-300 block uppercase">Real-time status</span>
                <p>
